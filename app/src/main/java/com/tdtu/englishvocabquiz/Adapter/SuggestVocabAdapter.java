...
public class SuggestVocabAdapter extends RecyclerView.Adapter<SuggestVocabAdapter.SuggestVocabViewHolder> {
    ...
    @NonNull
    @Override
    public SuggestVocabAdapter.SuggestVocabViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SuggestVocabAdapter.SuggestVocabViewHolder(LayoutInflater.from(context).inflate(R.layout.suggest_vocab_item, parent,false));
    }



    @Override
    public void onBindViewHolder(@NonNull SuggestVocabAdapter.SuggestVocabViewHolder holder, int position) {
